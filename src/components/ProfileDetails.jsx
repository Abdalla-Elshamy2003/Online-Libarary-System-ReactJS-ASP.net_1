        ...
        <div className="container mx-auto py-[60px]">
          <div className="flex flex-col items-center">
            <div className="relative">
              ...
              />
              <div className="absolute left-0 bottom-0 rounded-b-3xl text-center text-[12px] text-black font-medium bg-slate-100 bg-opacity-[50%] w-full">
            ...
            <form className="mx-auto pt-16 max-w-xl sm:pt-20 w-full">
              ...
              <div className="mt-10 flex items-center justify-around gap-[40px]">
                <button
                  type="submit"
                  className="block w-full rounded-md bg-red-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-red-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Cancel
                </button>
                <button
